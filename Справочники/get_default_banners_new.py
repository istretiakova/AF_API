...
list_place_ids = pd.read_excel(r'F:\WORK\AdFox\API_Reports\17.02.2023\places.xlsx')['ID площадки']
...
file_name = r'F:\WORK\AdFox\API_Reports\17.02.2023\default_banners_info_{}.xlsx'.format(
