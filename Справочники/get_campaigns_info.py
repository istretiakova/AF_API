...
campaigns_list = pd.read_csv(r'F:\WORK\Объединение с ГПМД\AF-account\01.11.2021\oct_campaigns.csv', sep=';', encoding='cp1251')
n = 1

campaigns_info_rows = []

for campaign_id in campaigns_list['Campaign ID']:
...
file_name = r'F:\WORK\Объединение с ГПМД\AF-account\01.11.2021\oct_campaigns_info_{}.xlsx'.\
