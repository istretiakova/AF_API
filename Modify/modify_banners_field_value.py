...
files_url = r'F:\WORK\AdFox\API_Reports\07.12.2022\\'
in_file = f'{files_url}test_banners.csv'
...
for n, banner_id in enumerate(banners_list):
    ...
    set_params = (
        ...
        ('actionObject', 'banner'),
        ('objectID', banner_id),
        ('trackingURL', trackingURL_new_value),
        ('encoding', 'UTF-8')
    )
    ...
    #                             "old_parameter1_value": parameter1_value,
    #                             "new_parameter1_value": parameter1_new_value,
    #                             "error_code": set_error_code}
    #                            )

    banner_changes = pd.Series({"bannerID": banner_id,
                                "old_value": trackingURL_value,
                                "new_value": trackingURL_new_value,
                                "error_code": set_error_code}
                               )
