...
campaigns_list = pd.read_csv(r'F:\WORK\AdFox\API_Reports\02.11.2023\campaigns.csv',
                             sep=';', encoding='utf8')
n = 1
...
file_name = r'F:\WORK\AdFox\API_Reports\02.11.2023\campaigns_info_short_{}.xlsx'.\
