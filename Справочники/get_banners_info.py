...
campaigns_list = pd.read_csv(r'F:\WORK\AdFox\API_Reports\14.12.2022\campaigns.csv', sep='\t', encoding='utf8')
...
file_name = r'F:\WORK\AdFox\API_Reports\14.12.2022\imn_banners_info_{}.xlsx'.\
