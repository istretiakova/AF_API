# -*- coding: utf-8 -*-
"""
Created on Mon Jul 13 17:44:56 2020

@author: Irina Tretiakova

Получаем список Суперкампаний за период с date_from
...
file_name = r'F:\WORK\AdFox\API_Reports\01.04.2022\supercampaigns_{}.xlsx'.format(datetime.now().strftime("%Y-%m-%d-%H%M%S"))
