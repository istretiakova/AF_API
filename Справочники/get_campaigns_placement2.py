...
campaigns_list = pd.read_csv(r'F:\WORK\AdFox\API_Reports\02.08.2022\campaigns_baltika.csv', sep=';', encoding='utf8')
...
file_name = r'F:\WORK\AdFox\API_Reports\02.08.2022\campaigns_baltika_placement2_{}.xlsx'.format(datetime.now().strftime("%Y-%m-%d-%H%M%S"))
